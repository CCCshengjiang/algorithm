...
public class test {
    public static void main(String[] args) {
        Student s1 = new Student(1,  18,"张三");
        Student s2 = new Student(2,  20,"李四");
        Student s3 = new Student(3,  19,"王五");
        Student s4 = new Student(4,  22,"赵六");
        Student s5 = new Student(5,  21,"钱七");
        ...
        while (!myHeap.isEmpty()) {
            System.out.println(myHeap.pop().toString());
        }
